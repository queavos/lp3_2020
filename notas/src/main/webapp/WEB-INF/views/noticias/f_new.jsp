...
<h3>Crear Nota  </h3>
	...
	<label>Titulo</label>
	<input type="text" name="titulo" placeholder="Ingrese el titulo de la nota" class="form-control">  
	<br>
	<label>Fecha</label>
	<input type="date" name="fecha" placeholder="Ingrese el titulo de la nota" class="form-control"> 
	<br>
